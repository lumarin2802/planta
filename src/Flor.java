...
public Flor() {
    ...
    public Flor(String nombre, double altoTallo, boolean tieneHojas, String climaIdeal, String colorPetalos, int cantidadPetalos, String variedadFlor, String colorPistilo, String estacionFlorecimiento) {
